/* PORTED from Mesa: generated by external/mesa/src/broadcom/cle/gen_pack_header.py
 * from v3d_packet.xml for V3D 4.2. Do not hand edit; regenerate to update.
 * Include path repointed to the local v3d_gen.h shim. */
